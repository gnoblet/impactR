...
- [The main vignette for the main workflow (en version)](https://gnoblet.github.io/impactR/articles/1_main_workflow.html)
- [The main vignette for the main workflow (fr version)](https://gnoblet.github.io/impactR/articles/1_base_de_travail.html)

In R, use :
```{r documentation-vignettes, eval = F}
