...
- [The main vignette for the main workflow (en version)](docs/articles/1_main_workflow.html)
- [The main vignette for the main workflow (fr version)](docs/articles/1_base_de_travail.html)
