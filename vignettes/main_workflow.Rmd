...
So we will add the survey_duration column using the `svy_duration` function. We take the opportunity to add the time difference between two surveys per interviewer:
```{r survey-duration}
data <- data |> 
